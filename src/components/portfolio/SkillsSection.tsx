      ...
      <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-2">
        {skills.groups.map((group, i) => (
          <Reveal
            key={group.title}
            delay={0.06 * i}
            className="group relative overflow-hidden rounded-3xl border border-line bg-surface/50 p-7 transition-colors hover:border-accent/40 md:p-9"
          >
            <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-accent/5 blur-2xl transition-opacity group-hover:opacity-100 md:opacity-0" />
