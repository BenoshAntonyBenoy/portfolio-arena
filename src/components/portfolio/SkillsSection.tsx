        ...
        {skills.groups.map((group, i) => (
          <Reveal key={group.title} delay={0.06 * i} className="h-full">
            <TiltCard
              max={5}
              lift={6}
              className="group relative h-full overflow-hidden rounded-3xl border border-line bg-surface/50 p-7 transition-[border-color,box-shadow] duration-300 hover:border-accent/40 hover:shadow-[0_0_0_1px_rgba(216,168,114,0.35),0_24px_55px_-30px_rgba(216,168,114,0.3),0_30px_60px_-30px_rgba(0,0,0,0.9)] md:p-9"
            >
